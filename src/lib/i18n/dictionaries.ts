  ...
  ru: {
    ...
    buildings: {
      ...
      constructor: {
        ...
        hint: "Укажите количество этажей и подъездов — конструктор сам создаст все квартиры. Затем впишите площадь для каждой квартиры отдельно или скопируйте готовый этаж на остальные.",
        entrancesCount: "Количество подъездов",
        unitsInEntrance: "Квартир на этаже, подъезд",
        generate: "Сгенерировать квартиры",
        confirmRegenerate: "Пересоздать сетку квартир? Уже введённые площади будут сброшены.",
        floorLabel: "Этаж",
        ...
        areaPlaceholder: "м²",
        showAdvanced: "+ Добавить подвал / паркинг / коммерцию",
        hideAdvanced: "Скрыть дополнительные помещения",
        advancedHint:
          "Для помещений, которые не входят в стандартную сетку этажей (подвал, паркинг, отдельные коммерческие площади).",
      },
    },
    settings: {
      title: "Настройки",
  ...
  tj: {
    ...
    buildings: {
      ...
      constructor: {
        ...
        hint: "Шумораи ошёна ва подъездро нишон диҳед — конструктор худаш ҳамаи хонаҳоро месозад. Баъд масоҳати ҳар хонаро алоҳида ворид кунед ё ошёнаи тайёрро ба дигарон нусха кунед.",
        entrancesCount: "Шумораи подъездҳо",
        unitsInEntrance: "Хона дар ошёна, подъезд",
        generate: "Хонаҳоро сохтан",
        confirmRegenerate: "Сеткаи хонаҳоро аз нав созам? Масоҳатҳои воридкардашуда нест мешаванд.",
        floorLabel: "Ошёна",
        entranceLabel: "Подъезд",
        ...
        areaPlaceholder: "м²",
        showAdvanced: "+ Иловаи таҳхона / паркинг / тиҷорат",
        hideAdvanced: "Ҳуҷраҳои иловагиро пинҳон кардан",
        advancedHint:
          "Барои ҳуҷраҳое, ки ба сеткаи стандартии ошёнаҳо дохил намешаванд (таҳхона, ҷои мошингузорӣ, майдонҳои алоҳидаи тиҷоратӣ).",
      },
    },
    settings: {
      title: "Танзимот",
