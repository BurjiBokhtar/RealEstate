  ...
  ru: {
    ...
    clients: {
      ...
      form: {
        ...
        email: "Email",
        passport: "Паспорт",
        passportPlaceholder: "Серия и номер, кем и когда выдан",
        source: "Источник",
        status: "Статус",
    ...
    settings: {
      ...
      template: {
        ...
        hint: "Полный текст договора. При печати договора {{плейсхолдеры}} заменяются реальными данными клиента, объекта и суммы.",
  ...
  tj: {
    ...
    clients: {
      ...
      form: {
        ...
        email: "Email",
        passport: "Шиноснома",
        passportPlaceholder: "Серия ва рақам, аз ҷониби кӣ ва кай дода шудааст",
        source: "Манбаъ",
        status: "Ҳолат",
    ...
    settings: {
      ...
      template: {
        ...
        hint: "Матни пурраи шартнома. Ҳангоми чоп {{плейсхолдерҳо}} бо маълумоти воқеии мизоҷ, объект ва маблағ иваз мешаванд.",
        placeholders: "Плейсхолдерҳои дастрас",
      },
      sms: {
