...
export const dictionaries = {
  ru: {
    ...
    buildings: {
      ...
      floorBuilder: {
        ...
        hint: "Для каждого этажа укажите тип, количество и площадь помещений — подходит для подвалов и парковок (используйте отрицательный номер этажа, например -1), коммерческих помещений и квартир разной площади.",
        floor: "Этаж",
    ...
    settings: {
      ...
      company: {
        ...
        hint: "Используются для подстановки в текст договора.",
  ...
  tj: {
    ...
    dashboard: {
      ...
      remaining: "Боқимонда",
      allBuildings: "Ҳамаи ҶК",
      filterBuilding: "Филтр аз рӯи ҶК",
    ...
    buildings: {
      ...
      floorBuilder: {
        ...
        hint: "Барои ҳар ошёна навъ, шумора ва масоҳати ҳуҷраҳоро нишон диҳед — барои таҳхона ва ҷои мошингузорӣ рақами манфии ошёна истифода баред (масалан -1), инчунин барои ҳуҷраҳои тиҷоратӣ ва хонаҳои дорои масоҳати гуногун.",
        floor: "Ошёна",
    ...
    settings: {
      ...
      company: {
        ...
        hint: "Барои гузоштан ба матни шартнома истифода мешавад.",
