  ...
  ru: {
    ...
    buildings: {
      ...
      constructor: {
        ...
        bulkFillTitle: "Заполнить одну квартиру сразу на нескольких этажах",
        bulkPosition: "№ квартиры",
        bulkFromFloor: "Этаж от",
        bulkToFloor: "до",
        bulkApply: "Применить",
      },
    },
  ...
  tj: {
    ...
    buildings: {
      ...
      constructor: {
        ...
        bulkFillTitle: "Як хонаро якбора дар якчанд ошёна пур кардан",
        bulkPosition: "№ хона",
        bulkFromFloor: "Аз ошёна",
        bulkToFloor: "то",
        bulkApply: "Татбиқ кардан",
      },
    },
    settings: {
      title: "Танзимот",
