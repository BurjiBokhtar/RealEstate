...
export const dictionaries = {
  ru: {
    ...
    settings: {
      ...
      sms: {
        title: "SMS-напоминания об оплате (Payom.tj)",
        apiKey: "API ключ (Bearer токен)",
        ...
        endpoint: "Endpoint (только чтение)",
      },
  ...
  tj: {
    ...
    settings: {
      ...
      sms: {
        title: "SMS-хотиррасонии пардохт (Payom.tj)",
        apiKey: "Калиди API (Bearer token)",
        ...
        endpoint: "Endpoint (танҳо хондан)",
      },
