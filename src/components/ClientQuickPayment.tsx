      ...
      {eligible.length === 0 ? (
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          ...
          <button
            ...
            className="rounded-lg bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-all hover:bg-slate-800 hover:shadow-md active:scale-[0.98] disabled:opacity-50 disabled:hover:scale-100"
          >
